        ...
        <fieldset>
            <legend>Sortie à Paris? Partez maintenant!</legend>
                <form action="departez.php" method="post">
                        ...
                        <label>Lieu1:</label>
                        <select name ="lieu1" id="lieu1" onchange="select('lieu1', 'preference1')">
                        ...
                        <br/><br/>
                        <label>Lieu2:</label>
                        <select name ="lieu2" id="lieu2" onchange="select('lieu2', 'preference2')">
                        ...
                        <p><input type="submit" value="Partez" class="btn"></p>
